...
повторных unit tests.

Исправленный run `20260728-045945_42` подтвердил восстановление learning
trajectory: validation macro F1 вырос с 0.114 на эпохе 1 до 0.385, 0.563 и
0.626 на эпохах 2-4. Для Stage 8 anchor macro F1 на эпохе 4 был 0.627.
